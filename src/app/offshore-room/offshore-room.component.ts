...
@Component({
  selector: 'app-offshore-room',
  imports: [CommonModule, RouterModule],
  templateUrl: './offshore-room.component.html',
  styleUrl: './offshore-room.component.scss'
})
export class OffshoreRoomComponent {
  photos = [
    {
      src: 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=1400&q=80',
      alt: 'Offshore room main'
    },
    {
