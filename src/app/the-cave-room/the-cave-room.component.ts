...
@Component({
  selector: 'app-the-cave-room',
  imports: [CommonModule, RouterModule],
  templateUrl: './the-cave-room.component.html',
  styleUrl: './the-cave-room.component.scss'
})
export class TheCaveRoomComponent {
  photos = [
    {
      src: 'https://images.unsplash.com/photo-1505691723518-36a5ac3be353?auto=format&fit=crop&w=1400&q=80',
      alt: 'The Cave room main'
    },
    {
      src: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=1200&q=80',
      alt: 'The Cave details'
    },
    {
